...
int main(){
    ...
    while(1){
        ...
        cout<<" 7 -  A e B são conjuntos idênticos ou disjuntos: \n";
        cout<<" 8 - Calcule o produto escalar entre A e B \n";
        cout<<" 9 - O conjunto G, formado pelos membros que compõem a maior sub-cadeia ordenada de forma crescente em A....;\n";
            ...
            cout << " \n O valor é:" <<aux;
			   system("pause");
                break;
                 ...
                 case 9: 
             system("cls");
            cout << "\n \n O conjunto G, formado pelos membros que compõem a maior sub-cadeia ordenada de forma crescente em A;....\n\n";
            ContD = Diferenca(A,ContA,B,ContB,DIFERENCA);
                cout<<"I = {";
                Imprime(DIFERENCA,ContD);
                cout<<"}\n\n";
